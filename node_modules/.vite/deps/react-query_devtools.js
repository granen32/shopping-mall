import {
  es_exports,
  init_es
} from "./chunk-25A2WOAB.js";
import "./chunk-33BC7Z2D.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_devtools = __commonJS({
  "node_modules/react-query/lib/devtools/devtools.js"(exports) {
    ...
    function ReactQueryDevtools(_ref) {
      var initialIsOpen = _ref.initialIsOpen, _ref$panelProps = _ref.panelProps, panelProps = _ref$panelProps === void 0 ? {} : _ref$panelProps, _ref$closeButtonProps = _ref.closeButtonProps, closeButtonProps = _ref$closeButtonProps === void 0 ? {} : _ref$closeButtonProps, _ref$toggleButtonProp = _ref.toggleButtonProps, toggleButtonProps = _ref$toggleButtonProp === void 0 ? {} : _ref$toggleButtonProp, _ref$position = _ref.position, position = _ref$position === void 0 ? "bottom-left" : _ref$position, _ref$containerElement = _ref.containerElement, Container = _ref$containerElement === void 0 ? "aside" : _ref$containerElement;
    ...
    var ReactQueryDevtoolsPanel = _react.default.forwardRef(function ReactQueryDevtoolsPanel2(props, ref) {
      ...
      var _props$isOpen = props.isOpen, isOpen = _props$isOpen === void 0 ? true : _props$isOpen, setIsOpen = props.setIsOpen, handleDragStart = props.handleDragStart, panelProps = (0, _objectWithoutPropertiesLoose2.default)(props, ["isOpen", "setIsOpen", "handleDragStart"]);
